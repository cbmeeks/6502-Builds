...
;	CPY	#>Ram_top		; compare with top of RAM high byte			CB
;	BCC	MEM_OK		; branch if < RAM top							CB

;	BNE	LAB_GMEM		; if too large go try again					CB
					; else was = so compare low bytes				CB
;	CMP	#<Ram_top		; compare with top of RAM low byte			CB
;	BEQ	MEM_OK		; branch if = RAM top							CB

;	BCS	LAB_GMEM		; if too large go try again					CB
...
LAB_1BCA
	JSR	LAB_20AE		; print quote terminated string to Sutill/Sutilh
